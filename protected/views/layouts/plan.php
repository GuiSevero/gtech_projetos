        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
              <?php if(!Yii::app()->user->isGuest): ?>
               <li>
                <a href="<?php echo $this->createUrl('/user/view', array('id'=>Yii::app()->user->getId()))?>">Meus Projetos</a>
              </li>  
              <li>
                <a href="<?php echo $this->createUrl('/classPlan/create', array('view'=>'pastas'))?>">Criar Projeto</a>
              </li> 
              <?php endif; ?>
              <li>
                <a href="<?php echo $this->createUrl('/classPlan')?>">Projetos</a>
              </li>     
              <?php if(Yii::app()->user->isGuest): ?>
              <li>
